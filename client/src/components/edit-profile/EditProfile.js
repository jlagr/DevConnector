...
class CreateProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.profile.profile) {
      ...
      // Bring stills array back to CSV
      const skillsCSV = profile.skills.join(",");

      // If profile field doesn't exists, meke empty string
      ...
      profile.social.twitter = !isEmpty(profile.social.twitter)
        ...
        : "";
      profile.social.fecebook = !isEmpty(profile.social.fecebook)
        ? profile.social.fecebook
        : "";
